...
# irq tweaks
replace_string init.bullhead.rc "service msm_irqbalance /system/bin/msm_irqbalance -f /msm_irqbalance.conf" "service msm_irqbalance /system/bin/msm_irqbalance -f /vendor/etc/msm_irqbalance.conf" "service msm_irqbalance /system/bin/msm_irqbalance -f /msm_irqbalance.conf"
